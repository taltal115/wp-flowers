<div class="site-topbar topbar_header3">
	<div class="container">
		<div class="topbar-inner row clearfix">

			<div class="header-left-widgets col-xs-12 col-sm-6 col-md-6 ">
			...
			<div class="header-right-widgets col-xs-12 col-sm-6 col-md-6">
...
<header id="masthead" class="site-header main-menu4">
	<div class="header-wrap">
		<div class="container">
			<div class="row">
				
				<div class="header-center-logo col-sm-4 col-lg-3 col-sm-push-4 col-lg-push-0">
					<div class="site-branding padding-left-0">
						<?php if ( $header_logo_white = nb_flower_get_option('header_logo_white', false, 'url')) : ?>
							<a href="<?php echo esc_url( home_url( '/' ) ); ?>" title="<?php echo esc_attr( get_bloginfo( 'name', 'display' ) ); ?>" rel="home">
								<img src="<?php echo esc_url($header_logo_white);?>" alt="<?php get_bloginfo( 'name' ) ?>" />
							</a>
						<?php else: ?>
				...
				<span id="netbase-responsive-toggle" class="hidden-lg col-sm-4 col-sm-pull-4 col-lg-pull-0"><i class="fa fa-bars"></i></span> 
				<div class="header-mainmenu-navigation bottombar-header3 col-lg-8">
					<?php wp_nav_menu( array('theme_location' => 'primary', 'container' => '', 'items_wrap' => '%3$s' ) ); ?>
				</div>

				<div class="header-cart-search bottombar-header3 col-sm-4 col-lg-1">

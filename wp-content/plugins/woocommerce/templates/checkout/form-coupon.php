...
if ( empty( WC()->cart->applied_coupons ) ) {
	$info_message = apply_filters( 'woocommerce_checkout_coupon_message', __( 'יש לך קופון?', 'woocommerce' ) . ' <a href="#" class="showcoupon">' . __( 'לחץ כאן כדי להזין את הקוד שלך', 'woocommerce' ) . '</a>' );

...
<?php if ($widget_title) { ?>
    <h4 class="widget-title">
        <span class="txt-title"><?php echo $widget_title ?></span>
    </h4>
<?php } ?>
...
<?php if ($icon_selection == 'top') { ?>
    <div class="service_top clearfix <?php echo $icon_selection ?>">
        ...
        <?php } ?>
        <div class="content">
            <div class="service_box_primary_txt"><?php echo $title; ?></div>
            <span class="content-svboxed"><?php echo $content; ?></span>
            <div class="clearfix"></div>
            <?php if($btn_text): ?>
                <div class="read-more-page-link"><a class="btn btn-primary alpha btn_style clearfix" href="<?php echo $btn_url; ?>" role="button"><?php echo $btn_text; ?></a></div>
            <?php endif; ?>
        </div>
    </div>

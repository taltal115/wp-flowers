...
<div class="nbt-product-tabs-<?php echo $instance['_sow_form_id'];?>">        
    <div class="wctab-list" role="tabpanel">
        ...
        <div class="nav nav-tabs owl-carousel tabcat" role="tablist">
            ...
            <?php foreach ($products_list_tab as $key => $products): ?>
                <div class="pst-item <?php if ($i == 1) { echo $active;} ?>">
        ...
        <div class="tab-content tab-content-bestseller">
            ...
            foreach ($products_list_tab as $key => $products): 
                ...
                <div class="tab-pane fade in <?php if($i==1){echo $active ;} ?>" id="nbt-product-tab-<?php echo $key; ?>-<?php echo $instance['_sow_form_id'];?>">
                    <ul class="owl-carousel item-posts" id="nbt-product-tab-content-<?php echo $key; ?>-<?php echo $instance['_sow_form_id'];?>">
                     <?php
                        if ( $loop->have_posts() ) {
    ...
    <script type="text/javascript">
        ...
        <?php $i=0; foreach($products_list_tab as $key => $value):?>
                <?php if($i == 1): ?> initialize_owl(jQuery('#nbt-product-tab-content-<?php echo $key;?>-<?php echo $instance['_sow_form_id'];?>')); <?php endif;?>
